...
def main() -> None:
    ...
    print()
    print(f'{user_input}th value of fibonacci_recursive is: {fibonacci_recursive(user_input)}')
    print()
    print(f'{user_input}th value of fibonacci_iteration is: {fibonacci_iteration(user_input)}')
