...
def string_upper_lower() -> None:
    ...
    def to_lower_case(msg_to_lower: str) -> str:
        lower_msg = ''
...
def binominal():
    ...
    print(f'Binomial coefficient (n choose k, with iteration) is: {bino_iter(input_n, input_k)}')
    print(f'Binomial coefficient (n choose k, with recursion) is: {bino_recur(input_n, input_k)}')
